    ...
    if (!navigator.geolocation) {           //disabled
        ...
        function success(pos) {
            ...
            if (storedLocation) {
                ...
                $("header").html("<h2>" + `Welcome back to E Corp! You traveled ${distance.toFixed(2)} meters since your last visit.` + "</h2>");
        ...
        function fail() {
            ...
            $("#locationhere").html("<h1>Geolocation is blocked. Please allow geolocation to use this application.</h1>");
        }
